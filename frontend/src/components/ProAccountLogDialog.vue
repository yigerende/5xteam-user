...
let request
let observer
const labels = { login: '首次登录', recharge: '开通 Pro', oauth: '获取新 RT/AT', merge: '自动合并', invite: '邀请空间', accept: '进入空间', transfer: '合并空间', remove: '移出空间', space_merge: '四步流程', credentials: '准备凭据', push: '推送', quota: '额度查询', stage: '手动修正' }
